...
class EstablishmentController extends Controller
{
     ...
     * @return mixed
     */
    public function choose(MolDataRepository $molDataRepository, $laborOffice, $sequenceNumber, MolRepo $mol)
    {
        try {
            $establishmentNumber = EstablishmentNumber::make($laborOffice, $sequenceNumber);
            $establishment_data = $molDataRepository->getEstablishmentByNumber($establishmentNumber);
            $owner_id = $mol->getOwnerByEstablishmentId($establishmentNumber);
