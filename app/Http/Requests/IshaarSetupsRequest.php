...
class IshaarSetupsRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'min_ishaar_period'                          => 'required|integer|min:0|max:90',
            'max_ishaar_period'                          => 'required|integer|min:0|max:90',
            ...
            'regions.*'                                  => 'required|integer|not_in:2',
    ...
    public function attributes()
    {
        return [
            ...
            'regions.0'                                  => trans('ishaar_setup.attributes.regions'),
