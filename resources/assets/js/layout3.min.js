var Layout = function () {
    var e = "layouts/layout3/img/", o = "layouts/layout3/css/", t = App.getResponsiveBreakpoint("md"), n = function () {
        ...
        var t = location.hash.toLowerCase(), n = $(".hor-menu");
        ...
        var e = App.getViewPort().width, o = $(".page-header-menu");
        ...
        // metronic modification for layout3
        // recalculate the min-height for inner content (.page-content) for the new UI
        var e;
        if (App.getViewPort().height > ( $('.footer').offset().top + $('.footer').height() )) {
            e = App.getViewPort().height - ( $('.footer').offset().top + $('.footer').height() ) + $(".page-content").outerHeight() - 1;
            $(".page-content").css("min-height", e)
        }
    }, d = function () {
        var e = 100, o = 500;
