...
@section('title', trans('ishaar_types.headings.list'))
@section('content')
        <!-- BEGIN BREADCRUMBS -->
<div class="breadcrumbs">
    <h1>{{ trans('ishaar_types.headings.list') }}</h1>
    <ol class="breadcrumb">
        <li>
            <a href="{{ url('admin') }}">{{trans('user.home')}}</a>
        </li>
        <li class="active">{{ trans('ishaar_types.headings.list') }}</li>
    </ol>
</div>
<!-- END BREADCRUMBS -->
<div class="m-heading-1 border-green m-bordered">
    <h3> {{ trans('ishaar_types.headings.list') }} </h3>
    <p> {{ trans('ishaar_types.sub-headings.list') }} </p>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold uppercase"> {{ trans('ishaar_types.headings.list') }}</span>
                </div>
            </div>
                        ...
                        <div class="col-md-6 pull-right">
                            <div class="btn-group pull-right">
                                <button data-toggle="modal" data-target="#main"
                                        data-href="{{ route('admin.ishaar_types.create') }}"
                ...
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-hover order-column">
                        ...
                        <tr class="odd gradeX">
                            ...
                            <th>{{ trans('ishaar_types.attributes.name') }}</th>
                            ...
                            <tr class="odd gradeX {{ $single->hashids }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-lg btn-group-solid margin-bottom-10">
                                        <button data-toggle="modal" data-target="#main"
                                                data-href="{{ route('admin.ishaar_types.edit', $single->hashids) }}"
                                                class="btn blue">
                                            <i class="fa fa-edit"></i> {{ trans('labels.edit') }}
                                        </button>
                                        <button data-popout="true" data-token="{{ csrf_token() }}"
                                                data-id="{{ $single->hashids }}"
                                                data-hreff="{{ route('admin.ishaar_types.destroy', $single->hashids) }}"
