...
@section('title', trans('regions.headings.list'))
@section('content')
        <!-- BEGIN BREADCRUMBS -->
<div class="breadcrumbs">
    <h1>{{ trans('regions.headings.list') }}</h1>
    <ol class="breadcrumb">
        <li>
            <a href="{{ url('admin') }}">{{trans('user.home')}}</a>
        </li>
        <li class="active">{{ trans('regions.headings.list') }}</li>
    </ol>
</div>
<!-- END BREADCRUMBS -->
<div class="m-heading-1 border-green m-bordered">
    <h3> {{ trans('regions.headings.list') }} </h3>
    <p> {{ trans('regions.sub-headings.list') }} </p>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold uppercase"> {{ trans('regions.headings.list') }}</span>
                </div>
            </div>
                        ...
                        <div class="col-md-6 pull-right">
                            <div class="btn-group pull-right">
                                <button data-toggle="modal" data-target="#main"
                                        data-href="{{ route('admin.regions.create') }}"
                ...
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-hover table-checkable order-column">
                        ...
                        <tr class="odd gradeX">
                            ...
                            <th>{{ trans('regions.attributes.name') }}</th>
