...
<div class="row">
   <div class="col-md-12">
      ...
      <div id="chartdiv" data-href="{{ route('reportLaborerStatusChart') }}" data-value="statusValue" data-title="statusName"
         data-source="sourceField" data-token="{{csrf_token()}}"
         data-action="{{ url('admin/reports/get-ishaar-by-laborer-status/') }}"
      ...
      <table class="table table-striped table-bordered table-hover table-checkable order-column">
         <thead>
            <tr class="odd gradeX">
               ...
               <th>{{trans('reports.laborerStatus')}}</th>
            </tr>
         </thead>
         <tbody>
            <tr class="">
