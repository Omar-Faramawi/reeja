...
@section('title', trans('labels.reports.ishaarStatusReport'))
@section('content')
...
<div class="row">
   <div class="col-md-12">
      ...
      <div id="chartdiv" data-href="{{ route('reportStatusChart') }}" data-value="statusValue" data-title="statusName"
         data-source="sourceField" data-token="{{csrf_token()}}"
         data-action="{{ url('admin/reports/get-ishaar-by-status/') }}"
