                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            <div class="slimScrollDiv">
                                <form id="form" action="{{ url('/password/reset') }}" method="post" data-url="{{ url('/') }}">
                                    <div class="form-body">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            ...
                                            <label for="password">{{ trans('auth.parameters.password_confirmation') }}</label>
                                        <span class="help-block">{{ trans('auth.parameters.password_confirmation') }}
                                            ...</span>
                                        </div>
