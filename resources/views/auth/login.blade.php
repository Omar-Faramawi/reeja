                ...
                <div class="col-md-6">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <a href="javascript:;" class="collapse" data-original-title="{{ trans('labels.collabse') }}" title=""> </a>
                                <a href="javascript:;" class="reload" data-original-title="{{ trans('labels.reload') }}" title=""> </a>
                                <a href="" class="fullscreen" data-original-title="{{ trans('labels.fullscreen') }}" title=""> </a>
                                <a href="javascript:;" class="remove" data-original-title="{{ trans('labels.remove') }}" title=""> </a>
                            </div>
                        </div>
