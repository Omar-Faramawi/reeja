                  ...
                  <div class="portlet-body">
                     <div class="row">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6"><label>{{ trans('contracts_cancelation.contract_name') }}</label> : <span id='id'>{{ $contract->contract_name }}</span></div>
                           <div class="col-md-6"><label>{{ trans('contracts_cancelation.contract_description') }}</label> : <span id='id'>{{ $contract->contract_desc }}</span></div>
                           <div class="col-md-6"><label>{{ trans('contracts_cancelation.contract_type') }}</label> : <span id='id'>
                              @if($contract->contract_ref_no == null)
                                 {{ trans('contracts_cancelation.direct') }}
                              @else
                                 {{ trans('contracts_cancelation.indirect') }}
                              @endif
                           </span></div>
                        	<div class="col-md-6"><label>{{ trans('contracts_cancelation.contract_nature') }}</label> : <span id='id'>{{ $contract->contractNature->name }}</span></div>
   ...
   <div class="modal-dialog">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body form-body">
               ...
               {!! trans('approve_cancellation_disclaimer.cancel_approval', ['party' => $contract->benf_name, 'contract_number' => $contract->id, 'duration' => getDatesDiff($contract->start_date,$contract->end_date), 'start_date'=>$contract->start_date ]) !!}
