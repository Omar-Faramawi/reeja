...
<head>
    ...
    <title>{{ trans('labels.system_name').' | '.trans('ishaar_setup.print-head') }}</title>
    ...
    <div ui-view="content">
        <div class="aj-page" id="section-to-print">
          <div class="row" style="margin-bottom:7px !important">
            ...
            <h1 class="col-xs-6 text-center">{{trans('ishaar_setup.print-head')}} </h1>
            <div class="col-xs-3 text-center">
              {!! $barcode !!}
              <p>{{ $notice->id }}</p>
            </div>
          ...
          <div class="row">
            <div class="col-xs-12">
              <table class="table">
                ...
                <tr>
                  <th scope="row">{{trans('ishaar_setup.print-ishaar-emp-head3')}}</th>
                  <td colspan="3">{!! nl2br($notice->contract->contract_desc) !!}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    ...
                    <br>
                    <img src="//maps.googleapis.com/maps/api/staticmap?center={{$notice->contract->contractLocations[0]->desc_location}}&amp;zoom=16&amp;size=450x225&amp;maptype=roadmap&amp;markers=color:red%7Ccolor:red%7C{{$notice->contract->contractLocations[0]->desc_location}}&amp;sensor=false">
