                        ...
                        <div class="tab-pane active" id="tab_0">
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                {{ Form::open(['url' => '#','id'=>'form', 'class'=>'form-horizontal ishaars_form','data-url' => url('taqawel/notices/')]) }}
                                        <div class="form-body">
...
<div class="modal fade" id="refuse" tabindex="-1" aria-hidden="true">
   <div class="modal-dialog">
      {{ Form::open(['url' => 'taqawel/notices/ask_cancel', 'data-url'=>'', "files"=>"false",'id'=>'form','data-url' => url('taqawel/notices/')]) }}
