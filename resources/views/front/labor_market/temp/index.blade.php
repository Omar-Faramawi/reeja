        ...
        <div class="container">
            ...
            <div class="page-content-inner">
                ...
                @if( session()->get('service_type') === Constants::SERVICETYPES['benf'] )
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-primary btn-lg pull-right" value="" name="id"
                                    data-token="{{ csrf_token() }}" data-url="{{ request()->fullUrl() }}"
                                    data-route="{{ route('temp_work_labor_market.ask_offer') }}"
                                    id="ask-offer">{{ trans('temp_job.get_offer') }}</button>
                        </div>
                    </div>
                @endif
            </div>
