                                    ...
                                    <div class="portlet-body">
                                        <div class="row static-info">
                                            ...
                                            <div class="col-md-9 value form-group no-padding-top">
                                                {!! Form::select('contract_nature_id', $contractNatures, [], [ 'placeholder' => trans('labels.enter') . " " . trans('tqawel_offer_contract.contract_nature'), 'class' => 'form-control market-taqawel-sevices-id-add', 'action' => route('taqawel.get_contracts_by_contract_nature_id') ]) !!}
                                        ...
                                        <div class="row static-info" style="display: none;">
                                            ...
                                            <span class="col-md-9 value form-group no-padding-top">
                                               {!! Form::select('contract_ref_no', [], [], [ 'placeholder' =>  trans('tqawel_offer_contract.contract_ref_no'), 'class' => 'form-control' ]) !!}
                                            </span>
                                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-align-left col-md-12">
                    {!! Form::hidden('benf_id', $establishment->id) !!}
