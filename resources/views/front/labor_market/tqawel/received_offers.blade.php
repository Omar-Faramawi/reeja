        ...
        <div class="container">
            ...
            <div class="page-title">
                <h1>{{ trans('labels.system_name') }}
                    <small>{{ trans('temp_job.received_contracts') }}</small></h1>
            </div>
            <!-- END PAGE TITLE -->
                                            ...
                                            <table class="table table-striped table-bordered table-hover table-checkable">
                                                ...
                                                @foreach($mycontracts as $contract )
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a type="button" href="{{ url('taqawel/offer-taqawel-contract/'.$contract->id.'/edit') }}" class="btn blue btn-sm">{{ trans('tqawel_offer_contract.offer_contract') }}</a>
