                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a type="button" style="float:right" href="{{ url('direct-hiring-contracts/'.$contract->id.'/show') }}" class="btn blue btn-sm">{{ trans('temp_job.offer_contract') }}</a>
                                                        <a type="button" href="{{ url('direct-hiring-contracts/'.$contract->id.'/reject') }}" class="btn red btn-sm">{{ trans('temp_job.refuse') }}</a>
